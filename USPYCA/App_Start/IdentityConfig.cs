...
namespace USPYCA
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            correo.From = new MailAddress("noreply@cizcalli.gob.mx", "H. Ayuntamiento Cuautitlán Izcalli");
            correo.To.Add (message.Destination);
            correo.Subject = "Confirmación de correo";
            correo.SubjectEncoding = System.Text.Encoding.UTF8;
            correo.Body = (message.Body);
            correo.BodyEncoding = System.Text.Encoding.UTF8;
            correo.IsBodyHtml = true;

            SmtpClient smtp = new SmtpClient();

            smtp.Host = "mail.cizcalli.gob.mx"; 
            smtp.Port = 587; 
